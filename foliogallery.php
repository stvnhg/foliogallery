...
$thumb_width         = '380';   // width of thumbnails in pixels
...
{		
	...
	else
	{
		...
		<h1><?php echo $numAlbums; ?> albums</h1>
        <div class="clear"></div> -->
    	<ol class="breadcrumb">
			<li>Images</li>
		</ol>
...
else //display photos in album 
{
	...
	<ol class="breadcrumb">
		<?php if($fullAlbum==1) { ?>
			<li><a href="<?php echo $album_page_url; ?>">Images</a></li>
		<?php } ?>
		<li><?php echo $_REQUEST['album']; ?> (<?php echo $numFiles; ?> images)</li>
	</ol>
